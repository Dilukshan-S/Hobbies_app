...
$SQL="insert into Users (userType, userFName, userSName, userTelNo, userEmail, userPassword)
values ('C','".$fname."','".$lname."', '".$telno."', '".$email."', '".$password1."')";
//Execute the INSERT INTO SQL query
mysqli_query($conn, $SQL);

//create a regular expression variable
$reg = "/^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$/";
if (empty($fname) or empty($lname) or empty($telno) or empty($email)or 
...
$SQL="insert into Users (userType, userFName, userSName, userTelNo, userEmail, userPassword)
values (".$fname."','".$lname."', '".$telno."', '".$email."', '".$password1."')";
